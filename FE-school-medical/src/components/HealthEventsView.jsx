  ...
  const getDefaultTexts = () => {
    switch (userRole) {
      case 'parent':
        return {
          title: 'Health Events',
          description: 'View upcoming health events and appointments for your children',
          ...
          emptyDesc: 'Health events will appear here when they are scheduled by healthcare staff.'
        };
      case 'nurse':
        return {
          title: 'Health Events',
          description: 'View and manage all health events and appointments (past and upcoming)',
          subtitle: 'All Health Events',
          subtitleDesc: 'Manage all health events and appointments - past and upcoming',
    ...
    <div className="p-6 space-y-6 bg-gray-100 min-h-screen">
      ...
      <div className="bg-white rounded-lg shadow-sm border overflow-hidden">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900">{texts.subtitle}</h2>
        ...
        <div className="divide-y divide-gray-200">
          {healthEvents.length > 0 ? (
            healthEvents.map((event, index) => {
              ...
              return (
                <div key={event.eventId || index} className="p-6 hover:bg-gray-50 transition-colors">
            ...
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">{texts.emptyTitle}</h3>
