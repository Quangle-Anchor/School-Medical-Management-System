...
const HealthEventsCRUD = ({ title, description }) => {
  ...
  const finalDescription = description || 'Create, view, update, and delete health events';
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-6 w-full max-w-md">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-semibold">{isEditing ? 'Edit Health Event' : 'Create Health Event'}</h2>
    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-6 w-full max-w-md">
          ...
          <p className="mb-6">Are you sure you want to delete this health event? This action cannot be undone.</p>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border">
        <div className="p-6 border-b">
          ...
          <p className="text-gray-600 text-sm mt-1">Monthly view of all scheduled health events</p>
        </div>
        <div className="p-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border mb-6">
        <div className="p-6 flex justify-between items-center border-b">
          <div>
            ...
            <p className="text-gray-600 text-sm mt-1">Manage all scheduled health events in the system</p>
          </div>
          <button 
        ...
        <div className="divide-y">
          {events.length > 0 ? (
            events.map((event) => {
              ...
              let statusText = isPast ? 'Completed' : isToday ? 'Today' : 'Upcoming';
              
              return (
                <div key={event.eventId} className="p-6 hover:bg-gray-50">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <h3 className="text-lg font-medium">{safeDisplay(event.title || event.eventName)}</h3>
                      <p className="text-gray-600 mt-1">{safeDisplay(event.description)}</p>
                      
                      <div className="flex flex-wrap items-center gap-3 mt-3">
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${categoryStyle.bg} ${categoryStyle.text}`}>
            ...
            <div className="p-8 text-center text-gray-500">
              ...
              <h3 className="text-lg font-medium mb-1">No health events scheduled</h3>
              <p className="text-gray-500">Create your first health event using the button above.</p>
            </div>
          )}
        </div>
      </div>
