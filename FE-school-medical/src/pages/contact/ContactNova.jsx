    ...
    <NovaLayout>
      ...
      <section className="hero-section position-relative overflow-hidden py-5" style={{
            ...
            <div className="col-lg-8 mx-auto text-center">
              <div className="hero-content text-white" data-aos="fade-up">
                ...
                <p className="lead mb-4">
                  Reach out to our school health professionals for support with appointments, 
                  emergencies, or general inquiries. We're here to ensure every student's wellbeing.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="position-absolute top-0 start-0 opacity-10">
          <img src="/nova-assets/images/arch-line-reverse.svg" alt="" className="w-100" />
        </div>
      </section>
          ...
          <div className="row g-4">
              ...
              <div className="card h-100 border-0 shadow-sm text-center" data-aos="fade-up" data-aos-delay="200">
                <div className="card-body p-4">
                  ...
                  <div className="contact-details">
                    <p className="mb-1"><strong>Emergency:</strong> 024-3-555-0123</p>
                    <p className="mb-1"><strong>Health Office:</strong> 024-3-555-0124</p>
                    <p className="text-muted small">Available: Mon-Fri, 7:30 AM - 4:30 PM</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="card h-100 border-0 shadow-sm text-center" data-aos="fade-up" data-aos-delay="300">
                <div className="card-body p-4">
                  ...
                  <div className="contact-details">
                    <p className="mb-1"><strong>General:</strong> health@schoolhealth.com</p>
                    <p className="mb-1"><strong>Appointments:</strong> appointments@schoolhealth.com</p>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="card h-100 border-0 shadow-sm text-center" data-aos="fade-up" data-aos-delay="400">
                <div className="card-body p-4">
                  <div className="feature-icon mb-4">
                    <i className="bi bi-geo-alt-fill text-warning" style={{ fontSize: '3rem' }}></i>
                  </div>
                  ...
                  <div className="contact-details">
                    <p className="mb-1"><strong>Location:</strong> Building A, Room 105</p>
                    <p className="mb-1"><strong>Address:</strong> 123 School Street, Hanoi</p>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 text-center mb-5">
              ...
              <p className="lead text-muted" data-aos="fade-up" data-aos-delay="100">
                Dedicated professionals committed to student health and wellbeing
              </p>
            </div>
          </div>
          ...
          <div className="row g-4">
            {team.map((member, index) => (
              <div key={index} className="col-lg-4 col-md-6">
                <div className="card h-100 border-0 shadow-sm" data-aos="fade-up" data-aos-delay={200 + (index * 100)}>
                  <div className="card-body p-4 text-center">
                    <div className="feature-icon mb-4">
                      <i className={`bi ${member.icon} ${member.color}`} style={{ fontSize: '3rem' }}></i>
                    </div>
          ...
          <div className="row justify-content-center text-center">
            <div className="col-lg-8">
              <div data-aos="fade-up">
                <i className="bi bi-exclamation-triangle-fill mb-3" style={{ fontSize: '4rem' }}></i>
                <h2 className="display-6 fw-bold mb-4">Medical Emergency?</h2>
                <p className="lead mb-4">
                  For immediate medical emergencies during school hours, contact our health office immediately.
                </p>
                ...
                <p className="mt-3 opacity-75">
                  For life-threatening emergencies, call 115 (Vietnam Emergency Services)
                </p>
              </div>
            </div>
          </div>
