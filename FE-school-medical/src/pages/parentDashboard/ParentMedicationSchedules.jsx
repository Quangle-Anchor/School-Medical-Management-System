...
import { Calendar, Clock, User, Pill, AlertCircle, CheckCircle } from 'lucide-react';
  ...
  return (
    <div className="bg-gray-100 p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">View scheduled medication administration for your children</p>
      </div>
              ...
              <div className="px-2 py-2 border-b bg-gray-50 -mx-4 mb-4">
                <div className="flex items-center px-4">
                  ...
                  <span className="ml-2 text-sm text-gray-500">
                    ({studentSchedules.length} schedule{studentSchedules.length !== 1 ? 's' : ''})
                  </span>
                </div>
              </div>
              ...
              <div className="">
                <div className="grid gap-4">
                  {studentSchedules
                    ...
                    .map((schedule) => {
                      const upcoming = isUpcoming(schedule.scheduledDate, schedule.scheduledTime);
                      return (
                        <div 
                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              <div className="flex items-center mb-2">
                                ...
                                <span className="font-medium text-gray-900">Medication Administration</span>
                                {upcoming && (
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                                <div className="flex items-center">
                                  ...
                                  <span className="text-gray-700">{formatDate(schedule.scheduledDate)}</span>
                                </div>
                                <div className="flex items-center">
                                  <Clock className="w-4 h-4 text-gray-400 mr-2" />
                                  <span className="text-gray-700">{formatTime(schedule.scheduledTime)}</span>
                                </div>
                              </div>
                              ...
                              <div className="flex items-center text-sm text-gray-500">
                                <span>Administered by: {schedule.administeredBy}</span>
                              </div>
                            </div>
                          </div>
                        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-900">
                {schedules.filter(s => isUpcoming(s.scheduledDate, s.scheduledTime)).length}
              </div>
              <div className="text-sm text-blue-700">Upcoming</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-900">{Object.keys(groupedSchedules).length}</div>
